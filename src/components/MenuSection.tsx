...
const MenuSection = () => {
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      slicePieces: "Rp 5.000", // piecePrice diubah menjadi slicePrice
      wholePortion: "Rp 50.000 (10pcs)", // portionPrice diubah menjadi wholePrice
